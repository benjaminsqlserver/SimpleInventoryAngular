...
export class CategoriesGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  grid0LoadData(event: any) {
    this.conData.getCategories(`${event.filter}`, event.top, event.skip, `${event.orderby}`, event.top != null && event.skip != null, null, null, null)
    .subscribe((result: any) => {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to load Categories` });
    });
  }

  grid0Delete(event: any) {
    this.conData.deleteCategory(event.CategoryID)
    .subscribe((result: any) => {
