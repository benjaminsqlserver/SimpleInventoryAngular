...
export class ProductsGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  grid0LoadData(event: any) {
    this.conData.getProducts(`${event.filter}`, event.top, event.skip, `${event.orderby}`, event.top != null && event.skip != null, `Supplier,Category`, null, null)
  ...
  grid0Delete(event: any) {
    this.conData.deleteProduct(event.ProductID)
    .subscribe((result: any) => {
